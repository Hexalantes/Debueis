...
echo "Pardus The Archean Alpha 3"
...
cp ./lsb-release /mnt/etc/os-release
cp ./pardus-logo.png /mnt/usr/share/pixmaps/pardus-logo.png

echo "!!!NOT!!!"
echo "! BU KURULUM SCRIPTI/OS HALEN ALPHA AŞAMASINDADIR. KULLANICI SORUNLARI OLUŞMUŞ OLABİLİR !"
echo "! LÜTFEN REBOOT İŞLEMİNDEN ÖNCE ROOT VE KENDİ KULLANICINIZI KONTROL EDİN !"
echo "Tavsiye edilen işlemler:"
echo "arch-chroot /mnt"
echo "passwd"
echo "passwd [kendi kullanıcınız]"
echo "su [kendi kullanıcınız]"
echo "sudo pacman -Sy (sudo'yu test için)"
echo "! DAHA SONRA ARCHISO'YA DÖNÜP (bashrc'de root@archiso yazmalı) REBOOT ATMANIZ TAVSİYE EDİLİR !"
echo "Authors: Hexalantes & Heizen a.k.a. Archean Exercitus